...
static  OS_TCB   AppSystemTCB;
static  CPU_STK  AppSystemStk[100];
...
{
		OS_ERR      err;
		OSTaskCreate((OS_TCB     *)&AppSystemTCB,                /* Create the start task                                    */
		(CPU_CHAR   *)"Sys time",
		(OS_TASK_PTR ) Systime,
		(void       *) 0,
		(OS_PRIO     ) SYSTEM_TIME_PRIO,
		(CPU_STK    *)&AppSystemStk[0],
		(CPU_STK     )(100 / 10u),
		(CPU_STK_SIZE) 100,
		(OS_MSG_QTY  ) 0,
		(OS_TICK     ) 0,
